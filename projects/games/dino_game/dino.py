...
wn.bgpic("games/dino_game/background.gif")
wn.tracer(0)

wn.register_shape("games/dino_game/dinosaur.gif")
wn.register_shape("games/dino_game/cactus_small.gif")
...
jumper.speed(0)
jumper.shape("games/dino_game/dinosaur.gif")
jumper.color("green")
jumper.penup()
jumper.dy = 0
jumper.dx = 0
...
obstacle.speed(0)
obstacle.shape("games/dino_game/cactus_small.gif")
obstacle.color("red")
obstacle.penup()
obstacle.dx = -3
obstacle.height = 30
