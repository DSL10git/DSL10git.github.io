...
turtle.bgpic("games/SpaceWar/starfield.gif")  # Make sure this file exists in your directory
turtle.ht()
...
class Sprite(turtle.Turtle):
    def __init__(self, spriteshape, color, startx, starty):
        ...
        self.speed = 0
        self.hideturtle()  # Hide all sprites initially
...
class Game():
    def __init__(self):
        ...
        self.lives = 3
        self.instructions_pen = turtle.Turtle()
    ...
    def show_instructions(self):
        self.instructions_pen.speed(0)
        self.instructions_pen.color("white")
        self.instructions_pen.penup()
        self.instructions_pen.hideturtle()
        self.instructions_pen.goto(0, 200)
        self.instructions_pen.write("SPACE WAR", align="center", font=("Arial", 36, "bold"))
        ...
        instructions = [
            ...
            "",
            "Game Rules:",
            "- Destroy red enemies to earn 100 points",
            "- Avoid hitting blue allies (-50 points)",
            "- Don't crash into enemies (lose 1 life)",
        ...
        for line in instructions:
            self.instructions_pen.goto(0, y_pos)
            self.instructions_pen.write(line, align="center", font=("Arial", 14, "normal"))
            y_pos -= 30
            
    def clear_instructions(self):
        self.instructions_pen.clear()
...
# Create player and other objects (hidden initially)
...
turtle.onkey(start_game, "Return")  # Enter key
turtle.listen()
